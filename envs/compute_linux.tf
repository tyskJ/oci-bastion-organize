...
# Private Key
# ************************************************************/
resource "tls_private_key" "ssh_keygen_socks5" {
  algorithm = "RSA"
  rsa_bits  = 4096
}

resource "local_sensitive_file" "private_key_socks5" {
  filename        = "./.key/private_socks5.pem"
  content         = tls_private_key.ssh_keygen_socks5.private_key_pem
